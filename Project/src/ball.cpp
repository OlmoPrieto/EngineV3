...
void Ball::move(const Vec2& from, float dt) {
  ...
  m_acceleration.x = utils::Lerp(m_acceleration.x, 0.0f, time * 0.001f / (m_deceleration_time * m_speed));
  m_acceleration.y = utils::Lerp(m_acceleration.y, 0.0f, time * 0.001f / (m_deceleration_time * m_speed));
