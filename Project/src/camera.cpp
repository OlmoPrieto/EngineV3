...
void Camera::setProjectionToPerspective()
{
  ...
  // TODO: missing View matrix! this is projection
  ...
  Vec3 vec3ZAxis = Vec3::normalize(vec3Target - vec3Pos);
  ...
  //m_mat4ViewMatrix.transpose();

  m_mat4ViewMatrix = m_mat4ViewMatrix * mat4Rotation;

  m_mat4ViewMatrix = m_mat4ViewMatrix * m_mat4ProjectionMatrix;
}
